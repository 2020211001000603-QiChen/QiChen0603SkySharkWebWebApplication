<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ManageUsers.aspx.cs" Inherits="QiChen0603SkySharkWebWebApplication.NA.ManageUsers" %>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td>
                     ...
                     <td><asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/Login.aspx">Logoff</asp:HyperLink></td>
                     <td></td>
                     <td></td>
                </tr>
                <tr>
                 ...
                 <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBox2" runat="server" OnTextChanged="TextBox2_TextChanged" TextMode="Password"></asp:TextBox></td>
                    <td></td>
                     <td>
                 ...
                 <tr>
                    <td>
                        <asp:Label ID="d" runat="server" Text="Role"></asp:Label></td>
                    <td>

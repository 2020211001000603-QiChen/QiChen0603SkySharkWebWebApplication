<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CreateRes.aspx.cs" Inherits="QiChen0603SkySharkWebWebApplication.LOB.CreateRes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form id="form1" runat="server"><asp:Menu ID="Menu1" runat="server" BackColor="#F7F6F3" DynamicHorizontalOffset="2" Font-Names="Verdana" Font-Size="0.8em" ForeColor="#7C6F57" Orientation="Horizontal" StaticSubMenuIndent="10px">
        ...
        <Items>
            ...
            <asp:MenuItem NavigateUrl="~/LOB/ConfirmRes.aspx" Text="Create Reservation" Value="Create Reservation"></asp:MenuItem>
        </Items>
        ...
        <div class="tabContents"> 
            ...
            <asp:Wizard ID="Wizard1" runat="server" BackColor="#F7F6F3" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" Font-Names="Verdana" Font-Size="0.8em" ActiveStepIndex="2" OnFinishButtonClick="Wizard1_FinishButtonClick">
                ...
                <WizardSteps>
                    ...
                    <asp:WizardStep ID="WizardStep2" runat="server" Title="Find Flight Fare &amp; Status">
                        ...
                        <table>
                            ...
                            <tr>
                               ...
                               <tr>
                                <td>
                                    <asp:Label ID="Labe111" runat="server" Text="Destination"></asp:Label></td>
                                <td>
                    ...
                    <asp:WizardStep runat="server" Title="Make Reservation">
                        ...
                        <table>
                            <tr>
                                <td colspan="3">
                                    <asp:Label ID="Label11" runat="server" Text="Step3: Confirm Booking"></asp:Label></td>

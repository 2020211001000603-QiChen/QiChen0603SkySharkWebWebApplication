<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="QueryStat.aspx.cs" Inherits="QiChen0603SkySharkWebWebApplication.LOB.QueryStat" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <form id="form1" runat="server"><asp:Menu ID="Menu1" runat="server" BackColor="#F7F6F3" DynamicHorizontalOffset="2" Font-Names="Verdana" Font-Size="0.8em" ForeColor="#7C6F57" Orientation="Horizontal" StaticSubMenuIndent="10px">
        ...
        <Items>
            ...
            <asp:MenuItem NavigateUrl="~/LOB/QueryStat.aspx" Text="Query Status" Value="Quary Status" Selected="True"></asp:MenuItem>
     ...
     <table>
                <tr>
                    <td colspan="2">
                        <asp:Label ID="Label1" runat="server" Text="Enquriy About Flight and Ticket Status"></asp:Label></td>
                    <td></td>
                    ...
                    <asp:WizardStep ID="WizardStep1" runat="server" Title="Query Flight Status">
                        ...
                        <table>
                            <tr>
                             ...
                             <tr>
                                <td>
                                    <asp:Label ID="txtFlightNo" runat="server" Text="Flight Number"></asp:Label></td>
                                <td>
                    ...
                    <asp:WizardStep ID="WizardStep2" runat="server" Title="Query Ticket Status">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td><asp:Button ID="btnTStatSubmit" runat="server" Text="Submit" /></td>
                            <td></td>
                            </tr>
